...
- A user interface (UI) that allows users to:
  - View the list of articles with filtering by category
  - View article details (with different content visibility for anonymous vs logged users)
  - Sign up and log in
  - Access administrator panel for managing authors and articles (admin only)
- Login API: `/api/login/`
